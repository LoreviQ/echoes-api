export const CHARACTER_GENERATION = {
    PROMPT: {
        ...
        suffix: `Remember to provide the output strictly in the specified JSON format: {"name": "character name", "description": "2-3 paragraph description here", "bio": "200 character social media bio", "gender": "character gender", "nsfw": boolean}.`,
    },

    SYSTEM: {
        prefix: `You are an expert character creator and writer. Your task is to generate a character name and biography based on a list of ten descriptive words provided by the user.
...
export const CHARACTER_ATTRIBUTES = {
    PROMPT: {
        prefix: `Generate the behavioral and personality attributes for the following character based on their provided details.`,
        suffix: `Analyze the character's personality, background, demeanor, and any specific traits mentioned in their description and appearance. Based on this analysis, assign values to the attributes listed below.
    ...
    SYSTEM: {
        prefix: `You are an expert character psychologist and behavioral analyst. Your task is to carefully analyze the provided character details (name, gender, description, appearance, nsfw status) and generate a corresponding set of behavioral and personality attributes.
