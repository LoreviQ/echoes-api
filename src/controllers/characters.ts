...
function parseGeneratedCharacter(content: string): Character {
    try {
        ...
        if (!parsedData.name || !parsedData.gender || !parsedData.bio || typeof parsedData.nsfw !== 'boolean') {
...
3.  \`bio\`: A string containing a compelling character biography of 2-3 paragraphs, reflecting the essence, personality, potential appearance, and backstory hinted at by the provided descriptive words.
4.  \`nsfw\`: A boolean value indicating whether the character contains adult or mature themes (true) or is suitable for all audiences (false).
